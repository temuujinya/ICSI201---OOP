...
void EmployeeClass::input(){
	...
	cout<<"time"<<endl;
	cin>>workTime;
	setAll(new_id,new_name,new_position,workTime);
}
/*
...
/*
Объектуудын нэрийг өсөх дарааллаар эрэмбэлнэ
Сонголтын арга ашигласан
*/
...
/*
	Ажилтны дугаар өмнө нь өөр ажилтанд бүртгэгдсэн эсэхийг шалгана
*/
